...
export default function What() {
  return (
    <div className="container text-center animate-flip-up">
     <DivPartie
     titre="What is"
     sousTitre="Skilline?"
     ...
     />
      ...
      <div className="block items-center md:flex md:gap-10 justify-between gap-6 my-24 animate-fade-up">
        <div className="bg-[url(https://mhaecal.github.io/frontend/img/Rectangle%2019.png)]  bg-center bg-no-repeat bg-cover w-full h-[300px] flex items-center justify-center flex-col gap-5 animate-fade-up">
        ...
        <div className="bg-[url(https://mhaecal.github.io/frontend/img/Rectangle%2021.png)] animate-fade-up bg-center bg-no-repeat bg-cover w-full h-[300px] flex items-center justify-center flex-col gap-5">
